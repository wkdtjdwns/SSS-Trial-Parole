...
public class BlueGhost : MonoBehaviour
{
    ...
    [Header("빨간 유령")]
    public Transform redGhostTransform;
    ...
    void Update()
    {
        if (controller == null || playerTransform == null || redGhostTransform == null)
            return;
    ...
    private Vector3 GetRandomNearbyPosition()
    {
        ...
        Debug.LogWarning("BlueGhost: 랜덤 위치 탐색 실패");
    ...
    private void TrySetDestination(Vector3 targetPosition)
    {
        ...
        {
            Debug.LogWarning("BlueGhost: 경로 실패, 플레이어 추적");
